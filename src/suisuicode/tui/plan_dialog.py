...
_OPTIONS = [
    ...
    ("Tell SuisuiCode what to change", PlanChoice.FEEDBACK),
]
...
class InlinePlanWidget(Vertical, can_focus=True):
    ...
    def _build_content(self) -> str:
        lines = [
            "\n [bold #7C5CFC]SuisuiCode has written up a plan and is ready to execute. "
            "Would you like to proceed?[/bold #7C5CFC]\n"
        ]
